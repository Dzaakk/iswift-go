...
import (
	"gorm.io/gorm"
	"iswift-go-project/internal/class_room/delivery/http"
	class_room2 "iswift-go-project/internal/class_room/repository"
	class_room3 "iswift-go-project/internal/class_room/usecase"
)
